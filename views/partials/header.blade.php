            ...
            <div class="c-navbar-wrapper clearfix">
                ...
                <div class="c-brand c-pull-left" style="margin-bottom: 0; height: 45px;">
                    <a href="{{ url(locale()) }}" class="c-logo">
                        <img src="{{ Theme::url('img/logos/logo.svg') }}" alt="{{ setting('core::site-name-mini') }}" class="c-desktop-logo">
                        <img src="{{ Theme::url('img/logos/logo.svg') }}" alt="{{ setting('core::site-name-mini') }}" class="c-desktop-logo-inverse" style="height: 65px;">
                        <img src="{{ Theme::url('img/logos/logo.svg') }}" alt="{{ setting('core::site-name-mini') }}" class="c-mobile-logo" style="height: 65px;"> </a>
                ...
                <nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold">
                    {!! Menu::get('header', \Themes\Selcuklu\Presenter\HeaderMenuPresenter::class) !!}
                </nav>
